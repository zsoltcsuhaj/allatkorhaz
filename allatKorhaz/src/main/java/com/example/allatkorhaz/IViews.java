...
public interface IViews {
    ...
    public static final String ALLATOK = "allatok.fxml";
    public static final String KEZELESHOZZAADASA = "kezelesHozzaadasa.fxml";
    public static final String KEZELESTIPUSAI = "kezelesTipusai.fxml";
